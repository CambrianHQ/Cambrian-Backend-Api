...
/// QualifiedPlayEvents, CreatorFollows, TrackBoosts, Purchases, FanSubscriptions —
...
{
    /// <summary>Earliest qualified play on any of the creator's tracks (null when unplayed).</summary>
