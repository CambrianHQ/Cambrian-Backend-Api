...
public partial class AddCreatorsIdentityTable : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        // ── 2. Add CreatorUuid FK column to Tracks (nullable during migration) ──
        ...
        // ── 3. Backfill: create Creator rows for every user with Tier='creator',
        //    then set CreatorUuid on all Tracks ──
        migrationBuilder.Sql(@"
            -- Create a Creator row for every ApplicationUser who has uploaded tracks
            -- or who has Tier = 'creator'. Username defaults to a slug from email prefix.
            ...
            -- Backfill CreatorUuid on Tracks from the Creator record matching the ApplicationUser
            UPDATE ""Tracks"" t
