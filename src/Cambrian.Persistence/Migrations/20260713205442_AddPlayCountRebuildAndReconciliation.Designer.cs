...
namespace Cambrian.Persistence.Migrations
{
    ...
    [Migration("20260713205442_AddPlayCountRebuildAndReconciliation")]
    partial class AddPlayCountRebuildAndReconciliation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cambrian.Domain.Entities.CreatorStat", b =>
                {
                    ...
                    b.Property<long>("UniqueListenerCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasDefaultValue(0L);
            ...
            modelBuilder.Entity("Cambrian.Domain.Entities.PlayCountReconciliationEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<long>("ComputedPlayCount")
                        .HasColumnType("bigint");

                    b.Property<long>("ComputedUniqueListenerCount")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("StoredPlayCount")
                        .HasColumnType("bigint");

                    b.Property<long>("StoredUniqueListenerCount")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("RunId")
                        .HasDatabaseName("ix_play_count_reconciliation_entries_run_id");

                    b.HasIndex("TrackId")
                        .HasDatabaseName("ix_play_count_reconciliation_entries_track_id");

                    b.ToTable("PlayCountReconciliationEntries", (string)null);
                });

            modelBuilder.Entity("Cambrian.Domain.Entities.PlayCountReconciliationRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("MismatchesFound")
                        .HasColumnType("integer");

                    b.Property<int>("MismatchesRepaired")
                        .HasColumnType("integer");

                    b.Property<bool>("RepairRequested")
                        .HasColumnType("boolean");
                    ...
                    b.Property<int>("TracksScanned")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.HasIndex("StartedAtUtc")
                        .HasDatabaseName("ix_play_count_reconciliation_runs_started_at");

                    b.ToTable("PlayCountReconciliationRuns", (string)null);
                });
            ...
            modelBuilder.Entity("Cambrian.Domain.Entities.StreamSession", b =>
                {
                    ...
                    b.HasIndex("TrackId", "Qualified")
                        .HasDatabaseName("ix_stream_sessions_track_qualified");

                    b.HasIndex("TrackId", "UserId", "StartedAt")
            ...
            modelBuilder.Entity("Cambrian.Domain.Entities.PlayCountReconciliationEntry", b =>
                {
                    b.HasOne("Cambrian.Domain.Entities.PlayCountReconciliationRun", "Run")
                        .WithMany("Entries")
                        .HasForeignKey("RunId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
